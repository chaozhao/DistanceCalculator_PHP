...
LatLon.prototype.destinationPoint = function(brng, dist) {
  ...
  lon2 = (lon2+3*Math.PI) % (2*Math.PI) - Math.PI;  // normalise to -180..+180o
...
LatLon.prototype.rhumbDistanceTo = function(point) {
  ...
  // if dLon over 180Åã take shorter rhumb across anti-meridian:
...
LatLon.prototype.rhumbDestinationPoint = function(brng, dist) {
  var R = this._radius;
  var d = parseFloat(dist)/R;  // d = angular distance covered on earthÅfs surface
  var lat1 = this._lat.toRad(), lon1 = this._lon.toRad();
  brng = brng.toRad();
